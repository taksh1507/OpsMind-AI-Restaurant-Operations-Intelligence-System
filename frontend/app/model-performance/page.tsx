        ...
        <div className="p-6 rounded-[3px] border border-red-500/30 bg-red-900/10">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <button
                onClick={() => mutate()}
                className="mt-3 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-[3px] transition-colors text-sm font-display font-semibold tracking-wide"
              >
                Retry
              </button>
            </div>
  ...
  if (is404 || !data) {
    return (
      <div className="space-y-8">
        ...
        <div className="p-8 rounded-[3px] border border-line bg-surface/40  text-center max-w-2xl mx-auto space-y-6">
          <div className="mx-auto w-16 h-16 rounded-full bg-electric-950 flex items-center justify-center border border-line">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-[3px] bg-accent hover:opacity-80 text-white font-medium transition-all  disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isRetraining ? (
              <>
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-accent/20 pb-6">
        ...
        <div>
          <button
            onClick={handleRetrain}
            disabled={isRetraining}
            className="flex items-center gap-2 px-5 py-2.5 rounded-[3px] bg-electric-600 border border-accent/50 hover:bg-accent text-white transition-all  disabled:opacity-50 disabled:cursor-not-allowed text-sm font-semibold"
          >
            {isRetraining ? (
              <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* MAE Lift Card */}
        <div className="p-6 rounded-[3px] border border-accent/20 bg-surface/40  relative overflow-hidden group hover:border-accent/40 transition-all">
        ...
        <div className="p-6 rounded-[3px] border border-accent/20 bg-surface/40  relative overflow-hidden group hover:border-accent/40 transition-all">
          ...
          <p className="text-sm font-display font-semibold tracking-wide text-cream-dim uppercase tracking-wider">Model RMSE</p>
          <div className="mt-2 flex items-baseline gap-2">
      ...
      <div className="border border-accent/20 rounded-[3px] bg-surface/40  overflow-hidden">
